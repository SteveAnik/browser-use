<picture>
  ...
  <img alt="Shows a black Browser Use Logo in light color mode and a white one in dark color mode." src="https://github.com/browser-use/browser-use/raw/main/static/browser-use-dark.png"  width="full">
</picture>
